...
import {clearFilter, setBrand, setCategory, setStore,} from "@/features/filter/filterSlice";
    ...
    return (
        <aside className="lg:col-span-3 md:col-span-4 col-span-12">
            <section className="flex flex-col gap-y-4 md:sticky md:top-4">
                ...
                {/* Choose Category */}
                <div
                    className="flex flex-col gap-y-4 border py-2 px-4 rounded-xl max-h-96 overflow-y-auto scrollbar-hide">
