        ...
        <Container>
            ...
            >
                <Image
                    ...
                    height={872}
                    width={500}
                    className="lg:absolute max-h-full  bottom-0 right-0 order-2 lg:w-[500px] lg:ml-0 md:ml-auto"
                />
                <article className="flex flex-col justify-start items-end order-1 px-8">
                    <div className="flex flex-col gap-y-4 max-w-lg z-20 mr-auto">
                        <h1 className="md:text-6xl text-4xl">
                            Welcome to <br/> <span className="text-primary">GH-Shop</span>
                        </h1>
                        <p className="flex flex-row gap-x-0.5 items-center text-lg text-black">
                            Experience the Future with Every Purchase
                        ...
                        <button
                            ...
                            onClick={() => router.push("https://github.com/phanluonghuy/GH-Shop")}
                        >
                            Start Your Queries
                        </button>
                    </div>
