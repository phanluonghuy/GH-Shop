...
import {useDeleteUserMutation, useUpdateUserMutation,} from "@/services/user/userApi";
            ...
            {isOpen && (
                ...
                >
                  ...
                  <span className="flex flex-row gap-x-1 items-center text-xs">
                    <Inform/> Brand: {user?.brand?.title}
                  </span>
                                    <span className="flex flex-row gap-x-1 items-center text-xs">
                    <Inform/> Category: {user?.category?.title}
                  </span>
                                    <span className="flex flex-row gap-x-1 items-center text-xs">
                    <Inform/> Store: {user?.store?.title}
                  </span>
                                </p>
                            </p>
                        </div>
