...
import {useAddCouponMutation, useGetCouponQuery, useUpdateCouponMutation} from "@/services/coupon/couponApi";
...
const Page = () => {
    ...
    const {
        data: fetchCouponData,
        isLoading: fetchingCoupon,
        error: fetchCouponError
    } = useGetCouponQuery(id, {skip: !id});
