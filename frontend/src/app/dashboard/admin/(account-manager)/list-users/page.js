...
import {useDeleteUserMutation, useGetUsersQuery, useReviewSellerMutation,} from "@/services/user/userApi";
            ...
            <section className="flex flex-col gap-y-6">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
                    ...
                    {user?.role}
                                ...
                                {user?.role === "admin" && (
                                    <span
                                        className="bg-purple-50 border border-purple-900 px-2 rounded-secondary text-purple-900 text-xs uppercase w-fit">
                    {user?.role}
                  </span>
                                )}
                                {user?.status === "inactive" && (
                                    <span
                                        className="bg-red-50 border border-red-900 px-2 rounded-secondary text-red-900 text-xs uppercase w-fit">
                    in review
                  </span>
                                )}
                            </p>
